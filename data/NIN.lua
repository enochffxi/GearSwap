...
function init_gear_sets()
    ...
    sets.precast.Waltz = {
        ...
        back="Iximulew Cape",waist="Caudata Belt",legs="Nahtirah Trousers",feet="Dance Shoes"}
    ...
    sets.midcast.ElementalNinjutsu = {
        ...
        back="Toro Cape",waist=gear.ElementalObi,legs="Nahtirah Trousers",feet="Koga Kyahan +2"}
    ...
    sets.idle = {
        ...
        body="Kirin's Osode",hands="Otronif Gloves +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Shadow Mantle",waist="Flume Belt",legs="Taeon Tights",feet=gear.MovementFeet}
