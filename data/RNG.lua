...
function init_gear_sets()
	...
	sets.precast.WS = {
		head="Orion Beret +1",neck=gear.ElementalGorget,ear1="Volley Earring",ear2="Clearview Earring",
		body="Taeon Tabard",hands="Taeon Gloves",ring1="Pyrosoul Ring",ring2="Rajas Ring",
		back="Sylvan Chlamys",waist=gear.ElementalBelt,legs="Taeon Tights",feet="Taeon Boots" }
	...
	sets.midcast.RA = {
		head="Orion Beret +1",neck="Ocachi Gorget",ear1="Volley earring",ear2="Clearview Earring",
		body="Sylvan Caban +2",hands="Manibozho Gloves",ring1="Paqichikaji Ring",ring2="Bellona's Ring",
		back="Lutian Cape",waist="Scout's Belt",legs="Orion Braccae",feet="Taeon Boots"}
	...
	-- Idle sets
	sets.idle = {
		head="Ocelomeh Headpiece +2",neck="Wiglen Gorget",ear1="Dawn Earring",ear2="Colossus's Earring",
		body="Kirin's Osode",hands="Orion Bracers +1",ring1="Sheltered Ring",ring2="Shneddick Ring",
	...
	sets.engaged = {
		head="Orion Beret +1",neck="Asperity Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
		body="Taeon Tabard", hands="Arcadian Bracers", ring1="Shneddick Ring",ring2="Rajas Ring",
		back="Lutian Cape",waist="Windbuffet Belt",legs="Taeon Tights",feet="Taeon Boots"}
