...
function init_gear_sets()
    ...
    sets.idle.Field = {
        ...
        body="Acro Surcoat",hands="Macabre Gauntlets +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Shadow Mantle",waist="Flume Belt",legs="Acro Breeches",feet="Loyalist Sabatons"}
    ...
    sets.engaged = {
        head="Yaoyotl Helm",neck="Asperity Necklace",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Acro Surcoat",hands="Macabre Gauntlets +1",ring1="Rajas Ring",ring2="Oneiros Ring",
        back="Atheling Mantle",waist="Windbuffet Belt",legs="Acro Breeches",feet="Loyalist Sabatons"}
