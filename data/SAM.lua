...
function init_gear_sets()
	...
	sets.precast.Waltz = {ammo="Sonia's Plectrum",
		head="Yaoyotl Helm",
		body="Karmesin Vest +1",hands="Buremte Gloves",ring1="Spiral Ring",
		back="Iximulew Cape",waist="Caudata Belt",legs="Wakido Haidate",feet="Otronif Boots"}
	...
	sets.precast.WS = {ammo="Thew Bomblet",
		...
		body="Karmesin Vest",hands="Otronif Gloves",ring1="Rajas Ring",ring2="Spiral Ring",
		back="Atheling Mantle",waist="Caudata Belt",legs="Wakido Haidate",feet="Sakonji Sune-ate"}
	...
	sets.engaged = {ammo="Thew Bomblet",
		head="Yaoyotl Helm",neck="Asperity Necklace",ear1="Bladeborn Earring",ear2="Steelflash Earring",
		body="Karieyh Haubert +1",hands="Otronif Gloves +1",ring1="Rajas Ring",ring2="K'ayres Ring",
		back="Atheling Mantle",waist="Windbuffet Belt",legs="Otronif Brais +1",feet="Sakonji Sune-ate"}
