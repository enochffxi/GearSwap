...
function init_gear_sets()
    ...
    sets.precast.Waltz = {ring1="Spiral Ring",
        back="Iximulew Cape",waist="Caudata Belt",legs="Hagondes Pants +1"}
    ...
    sets.precast.FC = {ammo="Sapience Orb",
        head="Psycloth Tiara",neck="Orunmila's Torque",ear1="Etiolation Earring",ear2="Loquacious Earring",
        body="Luhlaza Jubbah +1",ring1="Prolix Ring",
        back="Swith Cape",waist="Witful Belt",legs="Gyve Trousers"}

    sets.precast.FC['Blue Magic'] = set_combine(sets.precast.FC, {body="Mavi Mintan +2"})

    sets.precast.Quick = set_combine(sets.precast.FC, {ammo="Impatiens",ring2="Veneficium Ring"})
    ...
    sets.midcast['Blue Magic'].Magical = {ammo="Dosis Tathlum",
        ...
        body="Helios Jacket",hands="Psycloth Manillas",ring1="Strendu Ring",ring2="Acumen Ring",
        back="Cornflower Cape",waist="Porous Rope",legs="Helios Spats",feet="Helios Boots"}
    ...
    sets.Learning = set_combine(sets.midcast['Blue Magic'].SkillBasedBuff, {hands="Assimilator's Bazubands +1"})
    ...
    sets.idle = {ammo="Dosis Tathlum",
        head="Rawhide Mask",neck="Sanctity Necklace",ear1="Etiolation Earring",ear2="Ethereal Earring",
