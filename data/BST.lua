...
function init_gear_sets()
    ...
    sets.precast.WS = {ammo="Jukukik Feather",
        head="Yaoyotl Helm",neck="Asperity Necklace",ear1="Moonshade Earring",ear2="Brutal Earring",
        body="Acro Surcoat",hands="Taeon Gloves",ring1="Pyrosoul Ring",ring2="Epona's Ring",
    ...
    sets.precast.WS['Cloudsplitter'] = set_combine(sets.precast.WS['Primal Rend'], {waist="Fotia Belt"})
    ...
    sets.midcast.Pet.WS = {ammo="Demonry Core",
        head="Totemic Helm +1",neck="Ferine Necklace",ear1="Ferine Earring",ear2="Sabong Earring",
    ...
    sets.resting = {ammo="Demonry Core",
        head="Twilight Helm",neck="Wiglen Gorget",ear1="Ferine Earring",ear2="Sabong Earring",
    ...
    sets.idle = {ammo="Demonry Core",
        head="Yaoyotl Helm",neck="Wiglen Gorget",ear1="Dawn Earring",ear2="Colossus's Earring",
        body="Acro Surcoat",hands="Acro Gauntlets",ring1="Paguroidea Ring",ring2="Sheltered Ring",
        back="Pastoralist's Mantle",waist="Nierenschutz",legs="Taeon Tights",feet="Skadi's Jambeaux +1"}
    ...
    sets.idle.Pet.Engaged = {ammo="Demonry Core",
        head="Anwig Salade",neck="Ferine Necklace",ear1="Ferine Earring",ear2="Sabong Earring",
    ...
    sets.engaged = {ammo="Demonry Stone",
        ...
        body="Mes'yohi Haubergeon",hands="Acro Gauntlets",ring1="Oneiros Ring",ring2="Epona's Ring",
        back="Atheling Mantle",waist="Hurch'lan Sash",legs="Taeon Tights",feet="Whirlpool Greaves"}
