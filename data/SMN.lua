...
function init_gear_sets()
	...
	sets.precast.BloodPactWard = {ammo="Seraphicaller",
		...
		back="Tiresias' Cape",waist="Jaq'ij Sash"}
	...
	sets.precast.FC = {
		...
		body="Dalmatica",ring1="Prolix Ring",
		back="Swith Cape",waist="Witful Belt",legs="Hagondes Pants",feet="Regal Pumps"}
	...
	sets.midcast.FastRecast = {
		head="Nahtirah Hat",neck="Orunmila's Torque",ear2="Loquacious Earring",
		body="Anhur Robe",hands="Hagondes Cuffs",ring1="Prolix Ring",
		back="Swith Cape",waist="Witful Belt",legs="Assiduity Pants",feet="Regal Pumps"}

	sets.midcast.Cure = {main="Tamaxchi",sub="Sors Shield",
		head="Nahtirah Hat",neck="Colossus's Torque",ear1="Roundel Earring",ear2="Beatific Earring",
		body="Heka's Kalasiris",hands="Hieros Mittens",ring1="Prolix Ring",ring2="Sirona's Ring",
		back="Tempered Cape",waist="Bishop's Sash",legs="Hagondes Pants",feet="Hagondes Sabots"}

	sets.midcast.Stoneskin = {
		head="Umuthi Hat",neck="Stone Gorget",ear1="Magnetic Earring",
		body="Anhur Robe",hands="Hagondes Cuffs",
		waist="Siegel Sash",legs="Haven Hose"}

	sets.midcast['Elemental Magic'] = {main="Venabulum",sub="Wise Strap",ammo="Dosis Tathlum",
		head="Hagondes Hat",neck="Eddy Necklace",ear1="Friomisi Earring",ear2="Hecate's Earring",
		body="Hagondes Coat +1",hands="Yaoyotl Gloves",ring1="Strendu Ring",ring2="Galdr Ring",
	...
	sets.midcast.Pet.BloodPactWard = {main="Soulscourge",sub="Vox Grip",ammo="Seraphicaller",
		head="Convoker's Horn +1",neck="Caller's Pendant",
		body="Caller's Doublet +2",hands="Convoker's Bracers",ring1="Evoker's Ring",ring2="Fervor Ring",
		back="Tiresias' Cape",waist="Jaq'ij Sash",legs="Caller's Spats +2",feet="Glyphic Pigaches"}

	sets.midcast.Pet.DebuffBloodPactWard = {main="Soulscourge",sub="Vox Grip",ammo="Seraphicaller",
		head="Convoker's Horn +1",neck="Caller's Pendant",
		body="Caller's Doublet +2",hands="Glyphic Bracers",ring1="Evoker's Ring",ring2="Fervor Ring",
	...
	sets.midcast.Pet.PhysicalBloodPactRage = {main="Uffrat +2",ammo="Seraphicaller",
		head="Convoker's Horn +1",neck="Caller's Pendant",
		body="Convoker's Doublet",hands="Glyphic Bracers",ring1="Evoker's Ring",ring2="Fervor Ring",
		waist="Diabolos's Rope",legs="Caller's Spats +2",feet="Convoker's Pigaches"}

	sets.midcast.Pet.PhysicalBloodPactRage.Acc = sets.midcast.Pet.PhysicalBloodPactRage

	sets.midcast.Pet.MagicalBloodPactRage = {main="Uffrat +2",ammo="Seraphicaller",
	...
	sets.resting = {main=gear.Staff.HMP,ammo="Seraphicaller",
		...
		back="Kumbira Cape",waist="Ninurta's Sash",legs="Stearc Subligar",feet="Serpentes Sabots"}
	
	-- Idle sets
	sets.idle = {main="Bolelabunga",sub="Sors Shield",ammo="Seraphicaller",
		head="Convoker's Horn +1",neck="Wiglen Gorget",ear1="Gifted Earring",ear2="Caller's Earring",
		body="Hagondes Coat +1",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Paguroidea Ring",
		back="Kumbira Cape",waist="Ninurta's Sash",legs="Stearc Subligar",feet="Herald's Gaiters"}
	...
	sets.idle.Avatar = {main="Gridarvor",sub="Vox Grip",ammo="Seraphicaller",
		head="Glyphic Horn +1",neck="Caller's Pendant",ear1="Gifted Earring",ear2="Caller's Earring",
		body="Hagondes Coat +1",hands="Serpentes Cuffs",ring1="Evoker's Ring",ring2="Sangoma Ring",
		back="Conveyance Cape",waist="Mujin Obi",legs="Assiduity Pants",feet="Convoker's Pigaches"}

	sets.idle.Spirit = {main="Gridarvor",sub="Vox Grip",ammo="Seraphicaller",
		head="Glyphic Horn +1",neck="Caller's Pendant",ear1="Gifted Earring",ear2="Loquacious Earring",
		body="Hagondes Coat +1",hands="Serpentes Cuffs",ring1="Evoker's Ring",ring2="Sangoma Ring",
		back="Samanisi Cape",waist="Fucho-no-Obi",legs="Glyphic Spats",feet="Herald's Gaiters"}

	sets.idle.Town = {main="Bolelabunga",sub="Sors Shield",ammo="Seraphicaller",
		head="Glyphic Horn +1",neck="Wiglen Gorget",ear1="Gifted Earring",ear2="Caller's Earring",
		body="Hagondes Coat +1",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Paguroidea Ring",
		back="Kumbira Cape",waist="Ninurta's Sash",legs="Stearc Subligar",feet="Herald's Gaiters"}

	-- Favor uses Caller's Horn instead of Convoker's Horn for refresh
	sets.idle.Avatar.Favor = {head="Caller's Horn +2"}
	sets.idle.Avatar.Melee = {hands="Regimen Mittens",back="Samanisi Cape",waist="Mujin Obi",legs="Convoker's Spats"}
	...
	sets.perp.Day = {body="Hagondes Coat +1",hands="Caller's Bracers +2"}
	sets.perp.Weather = {neck="Caller's Pendant",body="Hagondes Coat +1",hands="Caller's Bracers +2"}
	-- Carby: Mitts+Conv.feet = 1/tick perp.  Everything else should be +refresh
	sets.perp.Carbuncle = {main="Bolelabunga",sub="Sors Shield",
		head="Convoker's Horn +1",body="Hagondes Coat +1",hands="Carbuncle Mitts",legs="Assiduity Pants",feet="Convoker's Pigaches"}
