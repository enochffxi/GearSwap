...
function init_gear_sets()
    ...
    sets.precast.JA['Footwork'] = {feet="Tantra Gaiters"}
    sets.precast.JA['Formless Strikes'] = {body="Hesychast's Cyclas"}
    sets.precast.JA['Mantra'] = {feet="Hesychast's Gaiters"}

    sets.precast.JA['Chi Blast'] = {
        head="Melee Crown",
        body="Otronif Harness",hands="Hesychast's Gloves",
        back="Tuilha Cape",legs="Hesychast's Hose",feet="Anchorite's Gaiters"}

    sets.precast.JA['Chakra'] = {ammo="Iron Gobbet",
        head="Whirlpool Mask",
        body="Anchorite's Cyclas",hands="Taeon Gloves",ring1="Spiral Ring",
        back="Iximulew Cape",waist="Caudata Belt",legs="Taeon Tights",feet="Taeon Boots"}

    -- Waltz set (chr and vit)
    sets.precast.Waltz = {ammo="Sonia's Plectrum",
        head="Taeon Chapeau",
        body="Taeon Tabard",hands="Taeon Gloves",ring1="Spiral Ring",
        back="Iximulew Cape",waist="Caudata Belt",legs="Taeon Tights",feet="Dance Shoes"}
    ...
    sets.precast.WS = {ammo="Potestas Bomblet",
        ...
        back="Atheling Mantle",waist=gear.ElementalBelt,legs="Taeon Tights",feet="Taeon Boots"}
    sets.precast.WSAcc = {ammo="Honed Tathlum",body="Anchorite's Cyclas",back="Kayapa Cape"}
    sets.precast.WSMod = {ammo="Tantra Tathlum",head="Felistris Mask",legs="Otronif Brais +1",feet="Taeon Boots"}
    ...
    sets.idle = {ammo="Honed Tathlum",
        ...
        body="Kirin's Osode",hands="Garden Bangles",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Shadow Mantle",waist="Anguinus Belt",legs="Taeon Tights",feet="Hermes' Sandals +1"}
    ...
    sets.engaged = {ammo="Honed Tathlum",
        ...
        body="Qaaxo Harness",hands="Taeon Gloves",ring1="Oneiros Ring",ring2="Epona's Ring",
    ...
    sets.engaged.SomeAcc = {ammo="Honed Tathlum",
        ...
        back="Atheling Mantle",waist="Anguinus Belt",legs="Hesychast's Hose",feet="Qaaxo Leggings"}
    ...
    sets.engaged.Mod = {ammo="Thew Bomblet",
        ...
        back="Atheling Mantle",waist="Windbuffet Belt",legs="Hesychast's Hose",feet="Anchorite's Gaiters +1"}
    ...
    sets.engaged.PDT = {ammo="Thew Bomblet",
        ...
        back="Iximulew Cape",waist="Windbuffet Belt",legs="Hesychast's Hose",feet="Otronif Boots +1"}
    sets.engaged.SomeAcc.PDT = {ammo="Honed Tathlum",
        ...
        back="Atheling Mantle",waist="Anguinus Belt",legs="Hesychast's Hose",feet="Anchorite's Gaiters +1"}
    ...
    sets.engaged.Footwork.Acc = {ammo="Honed Tathlum",
        ...
        back="Letalis Mantle",waist="Anguinus Belt",legs="Hesychast's Hose",feet="Anchorite's Gaiters +1"}
