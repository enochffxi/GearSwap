...
function init_gear_sets()
    ...
    sets.precast.WS = {ammo="Ginsen",
        ...
        body="Acro Surcoat",hands="Acro Gauntlets",ring1="Rajas Ring",ring2="Cho'j Band",
        back="Atheling Mantle",waist=gear.ElementalBelt,legs="Yorium Cuisses",feet="Whirlpool Greaves"}
    ...
    sets.precast.WS['Sanguine Blade'] = {ammo="Ginsen",
        head="Reverence Coronet",neck="Eddy Necklace",ear1="Friomisi Earring",ear2="Hecate's Earring",
    ...
    sets.precast.WS['Atonement'] = {ammo="Iron Gobbet",
        head="Reverence Coronet",neck=gear.ElementalGorget,ear1="Creed Earring",ear2="Steelflash Earring",
    ...
    sets.idle = {ammo="Demonry Stone",
        head="Yaoyotl Helm",neck="Creed Collar",ear1="Creed Earring",ear2="Colossus's Earring",
        body="Acro Surcoat",hands="Yorium Gauntlets",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Shadow Mantle",waist="Flume Belt",legs="Blood Cuisses",feet="Yorium Sabatons"}
    ...
    sets.idle.Town = {main="Anahera Sword",ammo="Incantor Stone",
        ...
        back="Fierabras's Mantle",waist="Flume Belt",legs="Blood Cuisses",feet="Reverence Leggings +1"}
    ...
    sets.engaged = {ammo="Demonry Stone",
        ...
        back="Atheling Mantle",waist="Cetl Belt",legs="Yorium Cuisses",feet="Whirlpool Greaves"}
